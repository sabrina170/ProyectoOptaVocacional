...
<section>
 ...
 <div class="container">
  <div class="row row-cols-1 row-cols-md-3">
    <div class="col mb-4">
      <div class="card">
        <a type="button" data-toggle="modal" data-target="#basicExampleModal"><img src="../img/yape2.png"  class="card-img-top" alt="..."></a>
        <div class="card-body">
          <p class="card-text">
    ...
    <div class="col mb-4">
      <div class="card">
        <img src="../img/bcp2.png" class="card-img-top" alt="...">
        <div class="card-body">
          <p class="card-text">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <img src="../img/qr.jpeg" height="450px;" alt="" >
