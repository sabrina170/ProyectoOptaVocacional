        ...
        <table class="table table-hover table-light" >
          <thead class="table juicy-peach-gradient">
            <tr>
              ...
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">1 </div><br>¿Qué carrera desea <BR>estudiar mi hijo?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">2 </div><br>¿He hablado con mi<br> hijo de esta carrera?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">3 </div><br>¿Qué nivel de estudio tomará mi hijo?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">4 </div><br>¿En donde desea estudiar <br>mi hijo esta carrera?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">5 </div><br>¿Mi hijo ha hecho <br>OV para esta carrera?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">6 </div><br>¿Lo veo como para<br> estudiar esta carrera?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">7 </div><br>¿Con qué ayuda cuento para la Educ. de mi hijo?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">8 </div><br>¿En qué ciudad <br>podría estudiar mi hijo?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">9 </div><br>¿Cuánto invertiría <br>al mes en sus estudios?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">10 </div><br>¿En que sector<br> laboral se ubicaría mi  hijo?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">11 </div><br>¿A que cargo o <br> puesto aspiraría mi hijo?</th>
              <th scope="col"  style="color: black;"  class="text-center"><div class="btn btn-outline-black btn-rounded btn-sm px-2">12 </div><br>¿Veo a mi hijo <br>trabajando en esto?</th>
